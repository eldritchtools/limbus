...
export default function GiftsPage({ initGifts }) {
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.2rem", width: "100%" }}>
                {newGifts.length > 0 ? <React.Fragment>
                    ...
                    <div className={styles.giftIconGrid}>
                        {newGifts.map(([id, gift]) => <div key={id} className={styles.giftIconContainer}>
                            <Gift key={id} gift={gift} includeTooltip={true} />
                        </div>)}
                    </div>
                </React.Fragment> : null}
                {updatedGifts.length > 0 ? <React.Fragment>
                    ...
                    <div className={styles.giftIconGrid}>
                        {updatedGifts.map(([id, gift]) => <div key={id} className={styles.giftIconContainer}>
                            <Gift key={id} gift={gift} includeTooltip={true} />
                        </div>)}
                    </div>
                </React.Fragment> : null}
