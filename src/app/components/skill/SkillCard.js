...
export default function SkillCard({ skill, label = "", count = 0, level, mini = false, pre, includeSkillValues = true }) {
    ...
    return <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", gap: "0.1rem", marginBottom: "0.25rem", alignItems: "center" }}>
            ...
            {includeSkillValues ? <>
                <span style={pillStyle} {...getGeneralTooltipProps("Assumes all conditionals against a target with defense level equal to the offense level of the skill. Some passives and other effects may not be included.\nUse the calculator in Display Type in a Team Build for a more detailed calculation.")}>
