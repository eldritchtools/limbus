...
export default function GuessingScreen({ mode, settings, quiz, submitAnswer, endRound, skip, identities, isHost, countStr }) {
    return <>
        ...
        <CroppedImage key={quiz.problem.answer} problem={quiz.problem} answer={quiz.problem.answer} />
        ...
        {mode === "multi" && <>
            ...
            {quiz.answers?.length > 0 && <>
                <span style={{fontSize: "1.2rem", fontWeight: "bold"}}>
                    [{sinnerIdMapping[identities[quiz.answers[0]].sinnerId]}] {identities[quiz.answers[0]].name}
                </span>
