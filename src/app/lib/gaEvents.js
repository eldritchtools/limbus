...
export function triggerGameStartGAEvent(game, mode) {
    triggerGAEvent("game_start", {game, mode});
}

export function triggerGameCompleteGAEvent(game, mode) {
    triggerGAEvent("game_complete", {game, mode});
}

export function triggerChatJoinGAEvent(room_type) {
    triggerGAEvent("chat_join", {room_type});
}

export function triggerChatMessageGAEvent(room_type) {
    triggerGAEvent("chat_message", {room_type});
}

export function triggerRoomJoinGAEvent(room_type) {
    triggerGAEvent("room_join", {room_type});
}
