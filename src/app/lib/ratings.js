...
export const egoCriteria = [
    ...
    {
        label: "Utility",
        desc: "How useful its other effects are (healing, buffs, debuffs, special passive effects)"
    },
    {
        label: "Usability",
        desc: "How easy it is to use (sin costs in the teams its used in, setting up ideal conditions if needed, difficulty in utilizing its effects)"
    }
]